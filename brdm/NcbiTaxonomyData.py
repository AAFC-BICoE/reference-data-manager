...
class NcbiTaxonomyData(NcbiData, RefDataInterface):
    ...
    def __init__(self, config_file):
        ...
        self.backup_dir = super(NcbiTaxonomyData, self).backup_dir + self.config['ncbi']['taxonomy'][
            'destination_folder']
    ...
    def update(self):
        ...
        # directory to do an intermediate download
    ...
    def checksum(self, md5_file, file_name):
        try:
            ...
            logging.exception('Could not download or read MD5 file for file {}. Download of this file will not proceed.'.format(file_name))
            return False
    ...
    #method to download accID files and then blastdbcmd to get sequences from nt
    ...
    def format_taxonomy(self,filename):
        ...
        taxonomy.write("taxon_id; taxon_name; species; genus; family; order; class; phylum; kingdom; superkingdom\n")
        try:
